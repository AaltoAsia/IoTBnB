...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('store', ['$window', function ($window) {
        ...
        return {
            ...
            get: function (key) {
                if ($window.localStorage [key]&& key=="cart") { // add && key=="cart" since token is also stored in the local storage !
...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
        ...
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'views/templates/ngCart/addtocart.html';
                } else {
    ...
    .directive('ngcartCart', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'views/templates/ngCart/cart.html';
                } else {
                    return attrs.templateUrl;
                }
            },
    ...
    .directive('ngcartSummary', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'views/templates/ngCart/summary.html';
                } else {
                    return attrs.templateUrl;
                }
            }
    ...
    .directive('ngcartCheckout', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'views/templates/ngCart/checkout.html';
                } else {
                    return attrs.templateUrl;
                }
            }
